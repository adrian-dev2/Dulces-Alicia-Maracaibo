  ...
  return (
    <header data-role="Header" className="header-header">
      ...
      <div className="header-btn-group">
        <button className="header-login button">{props.sesion}</button>
        <button className="header-register button">{props.registrar}</button>
      </div>
...
Header.defaultProps = {
  ...
  imageSrc: '/external/logo-optimizado-1500h.png',
  imageAlt: 'logo dulces alicia maracaibo',
